...
_TREE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature_cipher_suite', full_name='trillian.Tree.signature_cipher_suite', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='trillian.Tree.display_name', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='trillian.Tree.description', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='private_key', full_name='trillian.Tree.private_key', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='storage_settings', full_name='trillian.Tree.storage_settings', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='public_key', full_name='trillian.Tree.public_key', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_root_duration', full_name='trillian.Tree.max_root_duration', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='trillian.Tree.create_time', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='update_time', full_name='trillian.Tree.update_time', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='deleted', full_name='trillian.Tree.deleted', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='delete_time', full_name='trillian.Tree.delete_time', index=16,
...
_SIGNEDLOGROOT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature', full_name='trillian.SignedLogRoot.signature', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='log_id', full_name='trillian.SignedLogRoot.log_id', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tree_revision', full_name='trillian.SignedLogRoot.tree_revision', index=5,
...
_SIGNEDMAPROOT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp_nanos', full_name='trillian.SignedMapRoot.timestamp_nanos', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='root_hash', full_name='trillian.SignedMapRoot.root_hash', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='signature', full_name='trillian.SignedMapRoot.signature', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='map_id', full_name='trillian.SignedMapRoot.map_id', index=3,
      number=5, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='map_revision', full_name='trillian.SignedMapRoot.map_revision', index=4,
      number=6, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='trillian.SignedMapRoot.metadata', index=5,
...
_TREE.fields_by_name['signature_cipher_suite'].enum_type = crypto_dot_sigpb_dot_sigpb__pb2._DIGITALLYSIGNED_SIGNATURECIPHERSUITE
...
_SIGNEDLOGROOT.fields_by_name['signature'].message_type = crypto_dot_sigpb_dot_sigpb__pb2._DIGITALLYSIGNED
_SIGNEDMAPROOT.fields_by_name['signature'].message_type = crypto_dot_sigpb_dot_sigpb__pb2._DIGITALLYSIGNED
_SIGNEDMAPROOT.fields_by_name['metadata'].message_type = google_dot_protobuf_dot_any__pb2._ANY

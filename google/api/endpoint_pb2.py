...
_ENDPOINT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='target', full_name='google.api.Endpoint.target', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='allow_cors', full_name='google.api.Endpoint.allow_cors', index=5,

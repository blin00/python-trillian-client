...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='sigpb',
  syntax='proto3',
  serialized_pb=_b('\n\x18\x63rypto/sigpb/sigpb.proto\x12\x05sigpb\"\xab\x03\n\x0f\x44igitallySigned\x12<\n\x0ehash_algorithm\x18\x01 \x01(\x0e\x32$.sigpb.DigitallySigned.HashAlgorithm\x12\x46\n\x13signature_algorithm\x18\x02 \x01(\x0e\x32).sigpb.DigitallySigned.SignatureAlgorithm\x12K\n\x16signature_cipher_suite\x18\x04 \x01(\x0e\x32+.sigpb.DigitallySigned.SignatureCipherSuite\x12\x11\n\tsignature\x18\x03 \x01(\x0c\"%\n\rHashAlgorithm\x12\x08\n\x04NONE\x10\x00\x12\n\n\x06SHA256\x10\x04\"7\n\x12SignatureAlgorithm\x12\r\n\tANONYMOUS\x10\x00\x12\x07\n\x03RSA\x10\x01\x12\t\n\x05\x45\x43\x44SA\x10\x03\"R\n\x14SignatureCipherSuite\x12\x18\n\x14UNKNOWN_CIPHER_SUITE\x10\x00\x12\x0e\n\nRSA_SHA256\x10\x01\x12\x10\n\x0c\x45\x43\x44SA_SHA256\x10\x02\x42)Z\'github.com/google/trillian/crypto/sigpbb\x06proto3')
)
...
_DIGITALLYSIGNED_SIGNATURECIPHERSUITE = _descriptor.EnumDescriptor(
  name='SignatureCipherSuite',
  full_name='sigpb.DigitallySigned.SignatureCipherSuite',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='UNKNOWN_CIPHER_SUITE', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RSA_SHA256', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_DIGITALLYSIGNED_SIGNATURECIPHERSUITE)
...
_DIGITALLYSIGNED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature_cipher_suite', full_name='sigpb.DigitallySigned.signature_cipher_suite', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature', full_name='sigpb.DigitallySigned.signature', index=3,
  ...
  enum_types=[
    ...
    _DIGITALLYSIGNED_SIGNATURECIPHERSUITE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto3',
...
_DIGITALLYSIGNED.fields_by_name['signature_cipher_suite'].enum_type = _DIGITALLYSIGNED_SIGNATURECIPHERSUITE
...
_DIGITALLYSIGNED_SIGNATURECIPHERSUITE.containing_type = _DIGITALLYSIGNED
